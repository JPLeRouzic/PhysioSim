...
import ODEsolver.solvers.MathCalc;
...
public class SolverPanel extends JPanel
{
  ...
  public SolverPanel(double xMin, double xMax, double yMin, double yMax, double incr, double eps, Vector functionVector, Vector startVector)
  {
    this.xMin = xMin;
    this.xMax = xMax;
    this.yMin = yMin;
