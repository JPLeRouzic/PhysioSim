...
import ODEsolver.solvers.DormandPrince;
import ODEsolver.solvers.Euler;
import ODEsolver.solvers.EulerModified;
import ODEsolver.solvers.Heun;
import ODEsolver.solvers.RungeKutta;
import ODEsolver.solvers.RungeKuttaInc;
...
{
  static ResourceBundle res = ResourceBundle.getBundle("i18n/dessolver");
  ...
  private final JLabel        xminLabel = new JLabel(res.getString("LB_XMIN")+" ", JLabel.RIGHT);
  private final DecimalField  xminTextF = new DecimalField(xMin, 5);
  private final JLabel        xmaxLabel = new JLabel(res.getString("LB_XMAX")+" ", JLabel.RIGHT);
  private final DecimalField  xmaxTextF = new DecimalField(xMax, 5);
  private final JLabel        yminLabel = new JLabel(res.getString("LB_YMIN")+" ", JLabel.RIGHT);
  private final DecimalField  yminTextF = new DecimalField(yMin, 5);
  private final JLabel        ymaxLabel = new JLabel(res.getString("LB_YMAX")+" ", JLabel.RIGHT);
  private final DecimalField  ymaxTextF = new DecimalField(yMax, 5);
  private final JLabel        incrLabel = new JLabel(res.getString("LB_INCR")+" ", JLabel.RIGHT);
  private final DecimalField  incrTextF = new DecimalField(incr, 5);
  private final JLabel        erroLabel = new JLabel(res.getString("LB_ERROR")+" ", JLabel.RIGHT);
  private final DecimalField  erroTextF = new DecimalField(eps, 5);
  public final JTextArea     funcTextA = new JTextArea(function, 4, 10);
  private final JLabel        methodLabel = new JLabel(res.getString("LB_SOLVEMETHOD")+" ", JLabel.RIGHT);
  public final JComboBox     methodComboBox = new JComboBox(mathMethods);

  // The tabbed pane that holds the SolverPanel and TextArea for the results
  public JTabbedPane tabbedPane = new JTabbedPane();
  private Vector tabbedVector = new Vector(1,1);
  public TabbedPaneAction tabbedAction = new TabbedPaneAction();
  ...
  public MainPanel()
  {
    ...
    gPanel = new SolverPanel(xMin, xMax, yMin, yMax, incr, eps, functionstrings, startvector);
  ...
  public Vector SplitString(String split)
  {
  ...
  public Vector SplitFunction(Vector functions)
  {
  ...
  /**
   * Method that sets the whole environment of the MainPanel including
   ...
   * @version 1.0
   */
  public class TabbedPaneAction implements ChangeListener
  {
