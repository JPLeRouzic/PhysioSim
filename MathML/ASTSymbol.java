...
/**
 * Represents a <code>csymbol</code> MathML element. This can be extended by clients
 * who wish to supply custom symbol functions. 
 * 
...
public class ASTSymbol extends ASTNode {
	 ...
	 * 
	 * @param id
	 * @param isSymbolValue A <code>boolean</code> which is <code>true</code> if the created symbol will be 
	 * 	a value, rather than a function. If this argument is <code>false</code>, it is equivalent to <br>
	 * <pre>
	 * public ASTSymbol (String id)
	 * </pre>
	 * @since 2.1
	...
	@Override
	 protected ASTNumber doEvaluate(IEvaluationContext context) {
		return ASTNumber.createNumber(context.getValueFor(id).iterator().next());
	}
	...
	/**
	 * Boolean test for whether this symbol represents a value. Only one of <code>isSymbolValue()</code> 
	 * and <code>isSymbolFunction</code> can be true at once. 
	 * @return <code>true</code> if this symbol represents a value, or <code>false</code> if it represents
