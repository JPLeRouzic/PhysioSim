...
/**
 * Class representing nuumeric MathML elements. It contains various factory methods to create
 * AST nodes of various types
 * @author radams
 *
 */
public abstract class ASTNumber extends ASTNode{
	...
	public enum ASTNumberType implements ASTTypeI {
		...
		public String getString() {
			switch (code) {
			case 1: return "pi";
			case 2: return "exponentiale";
			case 3 : return "notanumber";
...
static Map<String, ASTNumberType> ENUMNAME_2_ENUM  = new HashMap<String, ASTNumberType>();
	...
	/**
	 * Given a function name, will return an {@link ASTNumber} for that name, or <code>null</code> if the
	 *  number type with that name does not exist.<p/>
	 *   This is a convenience method for constructing values from text input.
	 * @param fName A lower-case <code>String</code> corresponding to a number constant supported by this library. <br/>
	 *   Strings that will return constants are case-insensitive variants of: <ul>
	 *   <li>pi 
	 *   <li>e
	 *   <li>nan
	 *   <li> infinity
	...
	/**
	 * Boolean test for whether the supplied name is a supported constant (exp, pi, nan or infinity)
	 * @param name
	 * @return
	 */
	...
	/**
	 * Represents truth for boolean MathML statements. This has a default value of '1'
	 */
	public final static ASTNumber TRUE(){
	...
	/**
	 * Represents falsity for boolean MathML statements, and has a default value of '0'
	 */
	public final static ASTNumber FALSE (){
	 ...
	 */
	public final static ASTNumber E (){
	 ...
	 */
	public final static ASTNumber PI (){
	 ...
	 */
	public final static ASTNumber NaN (){
	 ...
	 */
	public final static ASTNumber INFINITY (){
	...
	/**
	 * Null number when AST cannot be evaluated e.g., due to incorrect construction
	 * of AST.
	 */
	public final static ASTNumber AST_NULL_NUMBER = new RealNumber(Double.NaN);
	
	/**
	 * Creates an {@link ASTNumber}  for a <code>double</code> of type {@link RealNumber}.
	 */
	...
	/**
	 * Creates a rational number. It is up to the client to test for the denominator
	 *  being 0.
	 * @param numerator a <code>integer</code>
	 * @param denominator a <code>integer</code>
	 * @throws IllegalArgumentException if <code>denominator</code> is zero.
	...
	/**
	 * Boolean test for whether number is rational (i.e., has numerator or denominator).
	 * @return
	 */
	...
	/**
	 * Boolean test for whether value is integer. This base class returns <code>false</code>,
	 ...
	 * @throws UnsupportedOperationException if isRational()!=true
	 * 
	 */
	...
	/**
	 * Returns denominator, but only if isRational()==true. Default is to throw an
	 * unsupported operation exception: subclasses can override
	 ...
	 *@throws UnsupportedOperationException if isEnotation()!=true
	 */
	...
	/**
	 * Get the mantissa of Enotation numbers, for numbers where isENotation() ==true
