...
/**
 * Visitor for traversing AST nodes for conversion to C-style strings as documented
 * in libSBML.
 * @author radams
 *
 */
public class ASTToFormulaVisitor extends ASTVisitor {
   ...
   StringBuffer sb = new StringBuffer();
    ...
    /**
     * Before visiting, this method will return the empty string. After visiting,
     * this method will return a C-style syntax String of the expression.
