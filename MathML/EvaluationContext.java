...
/**
 * Supplies substituted variable values for evaluation of ASTNode results.
 * There are various ways to populate the variable values, either through a constructor or 
 *  various overloaded setValueFor() methods.
 *  
 */
public class EvaluationContext implements IEvaluationContext {
	...
	/**
	 * This constructor makes a defensive copy of the map passed in. However the value itself is not copied.
	 * @param vars A <code>Map</code> of identifier-value pairs.
	 */
	...
	/**
	 * Sets the value for a vector value. This method does not make a defensive copy of the <code>value</code>,
	 *  so external changes to this array will affect this object. 
	 * @param identifier  A non-null <code>String</code>
	 * @param value A non-null {@link Iterable<Double>} vector of values
	 */
	...
	/**
	 * Sets the value for a vector value. This method makes a defensive copy of the input array. I.e,
	 * changes to the <code>data</code> object will not affect this object.
	 * @param identifier A non-null <code>String</code>
