...
/**
 * Root node for ASTNode. In an AST, this is the only node where the  parent is null.<br/>
 *  In this implementation, each root node has only a single child.<p/>
 * E.g., to start creating an AST:<p/>
