...
/**
 * Binary operator. This node should have two children with the meaning :<p/>
 *  pow(firstChild(), getChild(1)) i.e., the expression means the 1st child raised to the second child.
 * @author radams
 *
 */
