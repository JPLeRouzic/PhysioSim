package ODEsolver.solvers;

import ODEsolver.interpreter.Parser;
import java.util.*;
 ...
 * @author <A HREF="Juergen.Arndt@htw-dresden.de">J�rgen Arndt</A>
 * @author <A HREF="Felix.Kraemer@htw-dresden.de">Felix Kr�mer</A>
